...
sys.path.insert(0, "/work/btb44/Espalier_testing/Espalier/Espalier")  # directory containing Utils.py directly
import Utils
...
for seg0_seq_file in seg0_files:
    ...
    raxml = RAxMLRunner(raxml_path='/opt/apps/rhel8/raxml-ng-1.0.3/bin/raxml-ng-mpi', lsd_path='lsd2', temp_dir=temp_dir)
